    ...
    for ush in allu.each():
        ...
        if isinstance(user_data,dict):
            ...
            if verified:
                     ...
                     url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcUEZ6tpSCggZUFY5mJ5Z2Kl2sy0AiserqnWGtK1x5mQ&s"
...
def chat():
     ...
     return render_template("chatwith.html",images=images)
