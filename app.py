...
app.config['PWA_APP_NAME'] = 'My Flask App'
app.config['PWA_APP_DESCRIPTION'] = 'A Progressive Web App built with Flask'
...
def chatswith(profile):
    ...
    if sus:
        ...
        if request.method=="POST":
             ...
             {myid} send you a chat on picsta check it here,https://picsta.up.railway.app"""
             s.sendmail("picsta218@gmail.com", f"{mail}", message)
             s.quit()
